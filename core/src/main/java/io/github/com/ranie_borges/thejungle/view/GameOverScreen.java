...
public class GameOverScreen implements Screen {
    ...
    public GameOverScreen(Main game, String saveNameToDelete) {
        this.game = game;
    ...
    public void show() {
        ...
        try {
            gameOverLabel = new Label("GAME OVER", skin, gameOverStyleName);
            ...
            try {
                gameOverLabel = new Label("GAME OVER", skin); // Use first available LabelStyle
